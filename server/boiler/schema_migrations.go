...
type SchemaMigration struct {
	...
	R *schemaMigrationR `boiler:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
	L schemaMigrationL  `boiler:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
}
...
func (q schemaMigrationQuery) One(exec boil.Executor) (*SchemaMigration, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: failed to execute a one query for schema_migrations")
	}
...
func (q schemaMigrationQuery) All(exec boil.Executor) (SchemaMigrationSlice, error) {
	...
	err := q.Bind(nil, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boiler: failed to assign all query results to SchemaMigration slice")
	}
...
func (q schemaMigrationQuery) Count(exec boil.Executor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to count schema_migrations rows")
	}
...
func (q schemaMigrationQuery) Exists(exec boil.Executor) (bool, error) {
	...
	err := q.Query.QueryRow(exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boiler: failed to check if schema_migrations exists")
	}
...
func FindSchemaMigration(exec boil.Executor, version int64, selectCols ...string) (*SchemaMigration, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: unable to select from schema_migrations")
	}

	if err = schemaMigrationObj.doAfterSelectHooks(exec); err != nil {
...
func (o *SchemaMigration) Insert(exec boil.Executor, columns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no schema_migrations provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to insert into schema_migrations")
	}
...
func (o *SchemaMigration) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boiler: unable to update schema_migrations, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update schema_migrations row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by update for schema_migrations")
	}
...
func (q schemaMigrationQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all for schema_migrations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected for schema_migrations")
	}
...
func (o SchemaMigrationSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all in schemaMigration slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected all in update all schemaMigration")
	}
	return rowsAff, nil
}
...
func (o *SchemaMigration) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no schema_migrations provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("boiler: unable to upsert schema_migrations, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to upsert schema_migrations")
	}
...
func (o *SchemaMigration) Delete(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("boiler: no SchemaMigration provided for delete")
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete from schema_migrations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by delete for schema_migrations")
	}
...
func (q schemaMigrationQuery) DeleteAll(exec boil.Executor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boiler: no schemaMigrationQuery provided for delete all")
	}
	...
	result, err := q.Query.Exec(exec)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from schema_migrations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by deleteall for schema_migrations")
	}
...
func (o SchemaMigrationSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from schemaMigration slice")
	}
...
func (o *SchemaMigrationSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to reload all in SchemaMigrationSlice")
	}
...
func SchemaMigrationExists(exec boil.Executor, version int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boiler: unable to check if schema_migrations exists")
	}
...
func (o *SchemaMigration) Exists(exec boil.Executor) (bool, error) {
	return SchemaMigrationExists(exec, o.Version)
}
