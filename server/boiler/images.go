...
var ImageWhere = struct {
	...
	MimeType:      whereHelperstring{field: "\"images\".\"mime_type\""},
...
var (
	imageAllColumns            = []string{"id", "path", "file_size_bytes", "mime_type", "extension", "property_id", "uploader_id", "created_at", "updated_at", "deleted_at"}
	imageColumnsWithoutDefault = []string{"path", "file_size_bytes", "mime_type", "extension", "property_id", "uploader_id"}
