...
var (
	blobAllColumns            = []string{"id", "file_name", "mime_type", "file_size_bytes", "extension", "file", "views", "hash", "created_at", "updated_at", "deleted_at"}
	blobColumnsWithoutDefault = []string{"file_name", "mime_type", "file_size_bytes", "extension", "file"}
	blobColumnsWithDefault    = []string{"id", "views", "hash", "created_at", "updated_at", "deleted_at"}
